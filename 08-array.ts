...
const ingrs = veges.concat(source); // veges 배열에 sourc 배열 연결
...
const str = "JavaScript is something strang than other language";
...
// 인수가 2개 -> 인덱스부터 n개 추출 후 제거
console.log("SPLICE: ", fruits.splice(1, 2));
// 인수가 3개 이상 -> 인덱스부터 n개 추출 후 제거 후 새 요소 삽입
